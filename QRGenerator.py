...
class QRCodeApp(QWidget):
    ...
    def initUI(self):
        ...
        labelDomain = QLabel("Введіть значення (для BAR коду 12 цифр):")
...
# Buttons
        self.buttonQRGenerate = QPushButton("Генерувати QR код")
        self.buttonQRGenerate.clicked.connect(self.create_qr_code)

        self.buttonBARGenerate = QPushButton("Генерувати BAR код")
        self.buttonBARGenerate.clicked.connect(self.create_bar_code)

        self.buttonSaveImage = QPushButton("Зберегти код")
